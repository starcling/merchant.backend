...
describe('PaymentController: patch', () => {
    ...
    describe('with successful request', () => {
        it('should return ', (done) => {
            ...
            server
                .patch(`${endpoint}${updatePayment.id}?title=${title}`)
                .expect(200)
                .end((err: Error, res: any) => {
                    ...
                    expect(body).to.have.property('data').that.has.property('title').that.is.equal(title);
    ...
    describe('unsuccessfull request with invalid data', () => {
        it('should return ', (done) => {
            ...
            server
                .patch(`${endpoint}${updatePayment.id}?startts=string`)
