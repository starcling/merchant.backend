-- FUNCTION: public.fc_update_payment(uuid, integer, integer, bigint, bigint, bigint, integer, text);

-- DROP FUNCTION public.fc_update_payment(uuid, integer, integer, bigint, bigint, bigint, integer, text);
...
ALTER FUNCTION public.fc_update_payment(uuid, integer, integer, bigint, bigint, bigint, integer, text)
    OWNER TO local_user;
