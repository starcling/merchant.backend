-- FUNCTION: public.fc_update_payment_model(uuid, text, text, text, bigint, bigint, bigint, text, integer, integer, integer, integer);

-- DROP FUNCTION public.fc_update_payment_model(uuid, text, text, text, bigint, bigint, bigint, text, integer, integer, integer, integer);
...
ALTER FUNCTION public.fc_update_payment_model(uuid, text, text, text, bigint, bigint, bigint, text, integer, integer, integer, integer)
    OWNER TO local_user;
